                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contact-contacts.update", [$contactContact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nif" id="nif" value="{{ old('nif', $contactContact->nif) }}">
                            @if($errors->has('nif'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nif') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $contactContact->phone) }}">
                            @if($errors->has('phone'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('phone') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile" id="mobile" value="{{ old('mobile', $contactContact->mobile) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $contactContact->address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="country" id="country" value="{{ old('country', $contactContact->country) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="notes" id="notes" value="{{ old('notes', $contactContact->notes) }}">
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="internalnotes" id="internalnotes" value="{{ old('internalnotes', $contactContact->internalnotes) }}">
