    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.boats.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_boat') ? 'is-invalid' : '' }}" type="text" name="id_boat" id="id_boat" value="{{ old('id_boat', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mmsi') ? 'is-invalid' : '' }}" type="number" name="mmsi" id="mmsi" value="{{ old('mmsi', '') }}" step="1">
                @if($errors->has('mmsi'))
                    <div class="invalid-feedback">
                        {{ $errors->first('mmsi') }}
                    </div>
