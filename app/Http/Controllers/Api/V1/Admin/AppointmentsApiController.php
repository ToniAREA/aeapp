...
class AppointmentsApiController extends Controller
{
    public function index()
    {
        ...
        return new AppointmentResource(Appointment::with(['client', 'boat', 'wlists', 'for_roles', 'for_users'])->get());
    }
    ...
    public function show(Appointment $appointment)
    {
        ...
        return new AppointmentResource($appointment->load(['client', 'boat', 'wlists', 'for_roles', 'for_users']));
    }
