...
class AppointmentsApiController extends Controller
{
    public function index()
    {
        ...
        return new AppointmentResource(Appointment::with(['client', 'for_roles', 'for_users'])->get());
    }
    ...
    public function show(Appointment $appointment)
    {
        ...
        return new AppointmentResource($appointment->load(['client', 'for_roles', 'for_users']));
    }
