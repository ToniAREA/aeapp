...
class PrioritiesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.priorities.index', compact('priorities'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.priorities.create');
    }
    ...
    public function store(StorePriorityRequest $request)
    {
        ...
        return redirect()->route('frontend.priorities.index');
    }
    ...
    public function edit(Priority $priority)
    {
        ...
        return view('frontend.priorities.edit', compact('priority'));
    }
