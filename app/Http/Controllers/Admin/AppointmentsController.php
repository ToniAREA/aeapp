...
class AppointmentsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.appointments.create', compact('boats', 'for_roles', 'for_users', 'priorities', 'wlists'));
    }
    ...
    public function edit(Appointment $appointment)
    {
        ...
        return view('admin.appointments.edit', compact('appointment', 'boats', 'for_roles', 'for_users', 'priorities', 'wlists'));
    }
