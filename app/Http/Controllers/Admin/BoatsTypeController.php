...
class BoatsTypeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.boatsTypes.index', compact('boatsTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.boatsTypes.create', compact('boats_types'));
    }
    ...
    public function store(StoreBoatsTypeRequest $request)
    {
        ...
        return redirect()->route('admin.boats-types.index');
    }
    ...
    public function edit(BoatsType $boatsType)
    {
        ...
        return view('admin.boatsTypes.edit', compact('boatsType', 'boats_types'));
    }
    ...
    public function show(BoatsType $boatsType)
    {
        ...
        return view('admin.boatsTypes.show', compact('boatsType'));
    }
